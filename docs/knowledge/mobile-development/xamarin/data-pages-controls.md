...
- [HeroImage](https://docs.microsoft.com/en-us/xamarin/xamarin-forms/user-interface/datapages/controls#heroimage)
- [ListItem](https://docs.microsoft.com/en-us/xamarin/xamarin-forms/user-interface/datapages/controls#listitem)
...
The `ListItem` control's layout is similar to native iOS and Android lis or table rows, however it can also used as a regular view. In the example code below it is shown hosted inside a `StackLayout`, but it can also be used in data-bound scolling list controls.
...
Note that some values refer to `StaticResource`s - these will be defined in [step 5](https://docs.microsoft.com/en-us/xamarin/xamarin-forms/user-interface/datapages/controls#5).
...
Because this is a custom control, add the resources that match the theme you are using the rersource dictionary:
...
Finnally, ensure the C# class created in [step 1](https://docs.microsoft.com/en-us/xamarin/xamarin-forms/user-interface/datapages/controls#1) uses the control template defined in [step 4](https://docs.microsoft.com/en-us/xamarin/xamarin-forms/user-interface/datapages/controls#4) using a `Style` `Setter` element
